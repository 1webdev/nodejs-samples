...
ProfileRequest.prototype.stream = function () {
    return this.setPostfix('stream').get();
};

ProfileRequest.prototype.myStream = ProfileRequest.prototype.personalStream = function () {
    return this.setPostfix('personal-stream').get();
};

ProfileRequest.prototype.following = function (follower) {
    return this.setPostfix('following' + (follower ? '/' + follower : ''));
};

ProfileRequest.prototype.followers = function (follower) {
    return this.setPostfix('followers' + (follower ? '/' + follower : ''));
};

ProfileRequest.register = function (ApiClient) {
