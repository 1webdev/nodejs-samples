...
ConversationRequest.prototype.unread = function () {
    return this.setPostfix('unread').get();
};

ConversationRequest.prototype.status = function () {
    return this.setPostfix('status').put();
};

ConversationRequest.register = function (ApiClient) {
